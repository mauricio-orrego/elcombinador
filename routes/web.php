...
Route::get('entrada/{id}/entradafec', 'EntradaController@nueva')->name('nueva_entrada');
Route::put('entrada/{id}', 'EntradaController@actualizar')->name('actualizar_entrada');
Route::delete('entrada/validarx', 'EntradaController@eliminar')->name('eliminar_entrada');
